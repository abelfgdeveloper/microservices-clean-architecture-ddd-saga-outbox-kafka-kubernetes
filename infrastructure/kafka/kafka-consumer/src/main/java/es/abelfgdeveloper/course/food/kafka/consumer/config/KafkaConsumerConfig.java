package es.abelfgdeveloper.course.food.kafka.consumer.config;
...
import es.abelfgdeveloper.course.food.kafka.config.data.KafkaConfigData;
import es.abelfgdeveloper.course.food.kafka.config.data.KafkaConsumerConfigData;
